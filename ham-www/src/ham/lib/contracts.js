...
import HAMJson from '../clean_build/contracts/YAMDelegator.json';
import HAMRebaserJson from '../clean_build/contracts/YAMRebaser.json';
import HAMReservesJson from '../clean_build/contracts/YAMReserves.json';
